...
Fullstack-инженер с 2.5 годами коммерческого опыта. Работаю в мультистеке:
frontend (Next.js/Nuxt.js/Angular) и backend (Node.js/Python/PHP)

Разрабатываю продакшн-системы, строю pet-проекты.
Решаю алгозадачи на [Coderun](https://coderun.yandex.ru).

📬 [Telegram](https://t.me/stan1slavs) · 📧 stanislav-zabrodin@outlook.com

---

## Опыт

- **[Lolly](https://lolly.com)** — Fullstack developer · платформа инфлюенс-маркетинга
- **[Allsource](https://allsourcedata.io)** — Fullstack developer · data-платформа для рекламных аудиторий
...
| [HomeMonitoring](https://github.com/stanis1avs/home_monitoring) | Self-hosted мониторинг домашнего сервера со своим Go-ботом: алерты и управление Docker-контейнерами из Telegram | Go, Prometheus, Alertmanager, Grafana, Docker API |

---

## Стек

**Core:** TypeScript · JavaScript · Python · PHP

**Frontend:** Next.js · React · Angular · Nuxt.js · TailwindCSS · MUI

**Backend:** Node.js · NestJS · FastAPI · Express · Django

**Data:** PostgreSQL · MongoDB · ClickHouse · Redis · Qdrant · OpenSearch
